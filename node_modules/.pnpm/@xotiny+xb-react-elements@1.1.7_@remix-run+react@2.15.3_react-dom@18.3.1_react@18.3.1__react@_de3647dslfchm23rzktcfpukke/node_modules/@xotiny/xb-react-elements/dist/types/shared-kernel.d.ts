...
export type ExcludeAction = 'duplicate' | 'delete' | 'move' | 'drag' | 'add';
/**
 * Value động phụ thuộc vào các field được register
 */
export type FieldValue = any;
export interface CurrentElementSettings {
    /**
     * Các settings của element
     */
    [settingId: UniqueId]: FieldValue;
}
export interface DefaultAsyncZustandStore<T> {
    status: Status;
    data: T;
    errorMessage: string;
}
export type PageType = 'home' | 'product' | 'page' | 'collection' | '404';
