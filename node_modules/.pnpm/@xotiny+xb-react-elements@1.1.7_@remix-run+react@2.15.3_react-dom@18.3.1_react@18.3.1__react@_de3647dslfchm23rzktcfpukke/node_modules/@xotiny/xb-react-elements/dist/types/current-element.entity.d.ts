import type { CurrentElementSettings, ExcludeAction, UniqueId } from './shared-kernel';
export declare namespace CurrentElementEntity {
    type Template = string;
    interface DefaultElement<SettingsT extends CurrentElementSettings = CurrentElementSettings> {
        /**
    ...
    interface WrapperElement<SettingsT extends CurrentElementSettings = CurrentElementSettings> extends DefaultElement<SettingsT> {
        /**
    ...
    interface DynamicElement<SettingsT extends CurrentElementSettings = CurrentElementSettings> extends DefaultElement<SettingsT> {
        /**
